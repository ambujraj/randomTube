...
app.get("/result", function(req, res){
 ...
 Query.create({query: queryy, hits: hit, ip: ip});
    var ab = queryy.split(" ");
    queryy = ab.join("+");
    var urlpix = 'https://pixabay.com/api/videos/?key=9494342-0f51f6ed3422203dd259dafaa&q='+ queryy +'&pretty=true';
    var url = 'https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&safeSearch=strict&order=relevance&type=video&q=' + queryy + '&key=AIzaSyA58s6f45ex23jhsW0m54CpjhD71a4bJgc';
    ...
    request(url, function(error, response, body){
		...
		hit++;
             res.render("search", {search: parsed, pixx: parsedpix});
         }
    });
